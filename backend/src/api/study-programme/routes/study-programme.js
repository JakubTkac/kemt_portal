...
/**
 * study-programme router.
 */

const { createCoreRouter } = require("@strapi/strapi").factories;
const defaultRouter = createCoreRouter("api::study-programme.study-programme");
...
const myOverideRoutes = [
  {
    method: "GET",
    path: "/study-programmes/:slug",
    handler: "api::study-programme.study-programme.findOne",
  },
];
